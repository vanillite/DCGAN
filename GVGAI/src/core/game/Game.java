...
/**
	 ...
	 */
	 ...
	 public double[] getScreenShot(Player[] players, int randomSeed, boolean isHuman, int humanID, String screenShotFileName) {
		// Prepare some structures and references for this game.
		...
		for (Player player : players)
			if (player instanceof tracks.singlePlayer.tools.human.Agent) {
				delay = 1000.0 / CompetitionParameters.DELAY;
				break;
			}
