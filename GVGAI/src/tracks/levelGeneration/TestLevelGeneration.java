...
public class TestLevelGeneration {
    ...
    public static void main(String[] args) {
		...
		String generatorNames[] = new String[] {"randomLevelGenerator", "constructiveLevelGenerator"};
		//String generatorNames[] = new String[] {"randomLevelGenerator","geneticLevelGenerator","constructiveLevelGenerator"};
		...
		// 
		int generator_id = 1;
		String levelGenerator = "tracks.levelGeneration." + generatorNames[generator_id] + ".LevelGenerator";
		int numberOfLevels = 1024;
		tracks.levelGeneration.randomLevelGenerator.LevelGenerator.includeBorders = true;

		generateLevelPath = "examples/generatedLevels/" + generatorNames[generator_id] + "/";
		// examples\gridphysics\zelda.txt
		game = "examples/gridphysics/" + games[gameIdx] + ".txt";
		for (int i = 0; i < numberOfLevels; i++) {
			recordLevelFile = generateLevelPath + games[gameIdx] + "_lvl" + i + ".txt";
			LevelGenMachine.generateOneLevel(game, levelGenerator, recordLevelFile);
		}
