...
public class LevelGenerator extends AbstractLevelGenerator{
	...
	public LevelGenerator(GameDescription game, ElapsedCpuTimer elpasedTimer){
		...
		minSize = 10;
		maxSize = 10;
		levelSizeRandomPercentage = 1;
		levelSizeMaxPercentage = 1;
		//minSize = 4;
		//maxSize = 18;
	...
	@Override
	public String generateLevel(GameDescription game, ElapsedCpuTimer elapsedTimer) {
    	int fixedWidth = 10; // Replace with your desired width
    	int fixedLength = 10; // Replace with your desired length
    
    	return generateLevel(game, elapsedTimer, fixedWidth, fixedLength);
	}
