...
public class ArcadeMachine {
	...
	public static double[] getScreenShot(String game_file, String level_file, boolean visuals, String agentNames,
	    String actionFile, int randomSeed, int playerID, String screenShotFileName) {
		...
		double[] score;
		if (visuals)
			score = toPlay.getScreenShot(players, randomSeed, anyHuman, playerID, screenShotFileName);
